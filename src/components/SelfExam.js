...
const SelfExam = () => {
    ...
    return (
        <section className={style.selfExamContainer}>
            ...
            <p className={style.pExam}>As regiões anatômicas mais comum para o câncer de boca são bordas de língua e em sua região inferior, açoalho de boca, lábios inferiores e palato/céu da boca.
